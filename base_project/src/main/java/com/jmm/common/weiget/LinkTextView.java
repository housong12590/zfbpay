...
import com.jmm.common.link.LinkTouchMovementMethod;
import com.jmm.common.link.Linkify;
import com.jmm.common.R;
import com.jmm.common.span.OnSpanClickListener;
import com.jmm.common.weiget.textview.ISpanTouchFix;
 ...
 * @date 2017-03-17
 */
public class LinkTextView extends TextView implements OnSpanClickListener, ISpanTouchFix {
    ...
    public LinkTextView(Context context) {
        this(context, null);
        mLinkBgColor = null;
        mLinkTextColor = ContextCompat.getColorStateList(context, R.color.select_link_text_color);
    }
    ...
    public LinkTextView(Context context, AttributeSet attrs) {
        ...
        mLinkBgColor = array.getColorStateList(R.styleable.LinkTextView_link_BackgroundColor);
        mLinkTextColor = array.getColorStateList(R.styleable.LinkTextView_link_TextColor);
        array.recycle();
        if (mOriginText != null) {
            setText(mOriginText);
        }
